...
class BamlSyncClient:
    ...
    def ExtractFeatures(
      ...
      return cast(types.FeatureList, raw.cast_to(types, types))
...
class BamlStreamClient:
    ...
    def ExtractFeatures(
        ...
        resume_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.FeatureList, types.FeatureList]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[partial_types.FeatureList, types.FeatureList](
        raw,
        lambda x: cast(partial_types.FeatureList, x.cast_to(types, partial_types)),
        lambda x: cast(types.FeatureList, x.cast_to(types, types)),
        self.__ctx_manager.get(),
      )
